...
INSERT INTO `quotation_list` (`id`, `quotation_code`, `customer_name`, `type`, `sub_total`, `tax_rate`, `total_amount`, `remarks`, `date_created`, `date_updated`) VALUES
(1, 'Product-2851987', 'Jose Dela Torre', 1, 2356.14, 12, 2638.88, 'Sample Remarks for Quotation Product-2851987 transaction', '2022-09-24 22:11:09', NULL),
(2, 'Service-2905220', 'Jane Dimagiba', 2, 850, 12, 952, 'Sample Remarks for a Service Quotation Service-2905220', '2022-09-24 22:14:49', NULL);
